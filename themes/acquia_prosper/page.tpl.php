<?php
// $Id: page.tpl.php,v 1.1.2.2 2009/09/29 04:19:00 sociotech Exp $
  ...
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
      ...
      <div id="header-group-wrapper" class="header-group-wrapper full-width">
        <div id="euro-logos">
          <p>
          <?php echo l('<img src="/files/fp7.png" alt="Framework seven"/>', 'http://cordis.europa.eu/fp7/home_en.html', array('html' => 1))?>
          <?php echo l('<img src="/files/europe.png" alt="European flag"/>', 'http://europa.eu/index_en.htm', array('html' => 1))?><br/>
          <?php echo l('<img src="/files/e-infra.png" alt="E-Infra"/>', 'http://cordis.europa.eu/fp7/ict/e-infrastructure/home_en.html', array('html' => 1))?>
          </p>
        </div>
            ...
            <div id="header-site-info" class="header-site-info block">
              <div id="header-site-info-inner" class="header-site-info-inner inner">
                ...
                <div id="site-name-slogan" class="site-name-slogan">
                  <?php if ($site_name): ?>
                  <span id="site-name"><a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a></span>
                  <?php endif; ?>
                  <?php if ($site_slogan): ?>
