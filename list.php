...
if (isset($_GET['modules'])){
  ...
  // list
	...
	if(isset($_GET['thumbnails'])){
	  ?>document.write('<style type="text/css">.listhidden{display:none}.listnothidden{display:block}</style><h3><a onclick="prevBlock(\'allsites\');" id="prevscratchpads" style="listhidden">&lt;&lt;&lt;</a> [<a onclick="sortDivs(\'allsites\',\'nodes\');">Nodes</a> | <a onclick="sortDivs(\'allsites\',\'domain\');">Domain</a>] <a id="nextscratchpads" style="listnothidden" onclick="nextBlock(\'allsites\');">&gt;&gt;&gt;</a></h3><div id="allsites"><?php
	  $number_visible = 15;
	  $visible_count = 0;
