...
function scratchpad_training_profile_tasks(&$task, $url){
  if($task == 'profile'){
    ...
    variable_set('googlemap_api_key', ' INSERT API KEY HERE '); // FIXME
