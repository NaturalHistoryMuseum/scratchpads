...
class ADODB_oci8 extends ADOConnection {
	...
	// 2004-01-10 Originally above, but changed to get closer to UTC style
	// NOTE for data format quoted text will appear as is e.g. "T" and "Z"
	var $NLS_DATE_FORMAT = 'YYYY-MM-DD"T"HH:MI:SS"Z"';
