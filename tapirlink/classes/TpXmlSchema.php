...
class TpXmlSchema 
{
    ...
    var $mLocation;
    var $mrParser;
    var $mElementDecls   = array(); // name => XmlElementDecl obj
    var $mAttributeDecls = array(); // name => XmlAttributeDecl obj
    var $mTypes          = array(); // name => XmlType obj

    function TpXmlSchema( $namespace, $location, &$rParser ) 
    {
