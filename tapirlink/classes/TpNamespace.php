<?php
/**
 * $Id: TpNamespace.php 386 2007-06-06 14:23:33Z rdg $
 * 
 * LICENSE INFORMATION
 * 
...
class TpNamespace
{
    ...
    function TpNamespace( $prefix, $uri, $flag=null )
    {
        $this->mPrefix = $prefix;
        $this->mUri = $uri;
    ...
    } // end of member function TpNamespace
    ...
    function GetAttributeDecl( $name ) 
    {
        foreach ( $this->mSchemas as $loc => $schema )
        {
            $attr = $schema->GetAttributeDecl( $name );
