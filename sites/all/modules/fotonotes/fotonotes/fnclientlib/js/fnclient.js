...
var fnMinImgWidth = 100;	// MinWidth to make to apply to fn-image
var fnMinImgHeight = 100;	// MinHeight to make to apply to fn-image
...
function getFNDiv(imgObj, imageFile) {
	...
	if (fnDebugMode) alert('Final imageFile: \n\n' + imageFile);
 	...
 	var postContent = 'image=' + escape(imageFile) + '&action=' + 'display' + '&width=' + imgObj.width + '&height=' + imgObj.height + '&alt=' + imgObj.alt + '&style=&nid=' + imgObj.id;// + imgObj.style;
