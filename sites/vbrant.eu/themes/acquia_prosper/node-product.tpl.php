<?php
// $Id: node-product.tpl.php,v 1.1.2.1 2009/09/03 09:30:00 sociotech Exp $
?>

<div id="node-<?php print $node->nid; ?>" class="node <?php print $node_classes; ?> <?php print $skinr; ?> clear-block">
